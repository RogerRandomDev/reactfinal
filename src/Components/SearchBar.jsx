...
export default function SearchBar({search, setSearch}) {
    return (
        <div className="bg-[#3b69a2] bg-opacity-40 text-[#eee] p-5 rounded-md my-5">
            <div className="sm:flex sm:justify-center">
                <form action="" className="flex flex-col gap-8 sm:flex-row sm:w-full max-w-3xl sm:justify-between">
                    <input type="text" value={search} onChange={(e)=>setSearch(e.target.value)} name="query" placeholder="Search..." className="p-3 rounded border-2  outline-none text-neutral-900"></input>
                    <div className="flex items-center">
                    <label htmlFor="filter" className="mr-3">Sort By</label>
