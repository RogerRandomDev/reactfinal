...
function ProductDetail() {
  ...
  return (
    ...
    <div className="rounded p-8 grid bg-neutral-100 w-full grid-cols-1 md:gap-12 xl:grid-cols-[auto_auto] xl:justify-center xl:gap-48 items-start justify-items-center">
          <a href={`/profile?id=${productData.creatorID}`} className="text-sm font-normal no-underline text-purple-800 hover:text-purple-900 block md:hidden">{state.user.username}</a>
