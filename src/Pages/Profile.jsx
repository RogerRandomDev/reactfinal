...
function Profile() {
  ...
  return (
    ...
    <ProfileInfoCard image={"https://picsum.photos/400"} username={context.username} joinDate={context.joinDate} location={"Phoenix, AZ"} rating={0} ratingCount={0} bought={0} sold={0}/>
